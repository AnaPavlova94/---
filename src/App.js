...
const movieApi = 'https://imdb-api.com/en/API/SearchMovie/k_54ysq3jb/'
const movieTop = 'https://imdb-api.com/en/API/Top250Movies/k_54ysq3jb'
...
function App() {
  ...
  return (
    <>
       <header>
        <form action='submit' onSubmit={onHandleSearche}>
